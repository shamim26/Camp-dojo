const Footer = () => {
  return (
    <div
     ...
     items-center text-white bg-[#212026] py-16 space-y-8"
    >
      ...
      <div className="relative">
        ...
        <input
          className="absolute right-0 top-0 bottom-0
           bg-custom1 text-sm font-medium
            py-3 px-4 rounded-full hover:bg-gray-500 duration-300 cursor-pointer"
          type="submit"
          value="SUBSCRIBE"
        />
      </div>
      ...
      <p>
        ...
        and <span className="text-custom1 cursor-pointer"> Privacy Policy</span>
      </p>
    </div>
  );
};
