    ...
    <div>
      {!isLoading && (
        <Card className="fixed top-0 left-0 w-full h-screen overflow-auto rounded-none max-w-[20rem] p-4 bg-[#f2ad85]">
          ...
          {isAdmin?.admin ? (
            <List className="flex flex-col ml-6 gap-5">
              <NavLink
                ...
                className={(isActive) =>
                  isActive.isActive
                    ? "text-base text-white font-medium flex gap-3"
          ...
          <List className="flex flex-col ml-6 gap-5">
            <NavLink to="/" className="text-base font-medium flex gap-3">
              <HomeIcon className="h-6 w-6" />
              Home
            </NavLink>
            <NavLink to="/classes" className="text-base font-medium flex gap-3">
